...
|---|---|
| 표본 수 | 어르신 1,000명 |
| 연령 범위 | 50~99세 (60+ 비중 78%) |
| 관찰 기간 | 90일 (2026-01-01 ~ 2026-03-31) |
| 행동 로그 이벤트 수 | 약 350만~430만 |
| 일평균 이벤트 (가중 평균) | 약 43건 |
| 사용 패턴 종류 | 7종 |
| 인지 측정 페어 수 | 약 36만 페어 (전체 prompt의 약 60%) |
| 설문 응답 수 | 192,000 (사전 96k + 사후 96k) |
| 대화 turn 수 | 약 120만 (효돌+노인 합산) |
| 테이블 수 | 4 (profile / behavior_log / survey_responses / joined_wide) |
| Parquet 압축 후 사이즈 | 약 300~500 MB 예상 |
