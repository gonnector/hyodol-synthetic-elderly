...
| 테이블 | 행 수 | 컬럼 수 | Parquet 압축 예상 |
|---|---:|---:|---|
| `profile` | 1,000 | 약 55 | 1 MB 이하 |
| `behavior_log` | 약 4,000,000 | 약 30 (sparse) | 150~250 MB |
| `survey_responses` | 192,000 | 10 | 5~10 MB |
| `joined_wide` | 약 4,000,000 | 약 85 | 250~400 MB |
| **합계** | | | **약 400~660 MB** |
